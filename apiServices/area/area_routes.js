...
const area_controller = require("./area_controller");
const { check } = require('express-validator');
const { validarCampos } = require('../../middleware/validate_campos');
const auth = require('../../middleware/jwt');

router.getAsync("/list", [auth.checkjwt], area_controller.list);
...
check('imagen', 'Imagen es requerido').not().isEmpty(),
    validarCampos], area_controller.create);
